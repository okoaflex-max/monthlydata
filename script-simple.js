// Airtel Data Bundles JavaScript - Simple Working Version
...
function showDataPlans() {
    ...
    dataPlans.forEach(plan => {
        ...
        col.innerHTML = `
            <div class="card plan-card h-100 mb-4" data-plan-id="${plan.id}" onclick="selectPlan('${plan.id}')">
...
function showPaymentSection() {
    ...
    // Show payment section - SIMPLE AND DIRECT
            ...
            if (paymentStatus) {
                paymentStatus.innerHTML = `
                    <div class="alert alert-success">
                        ...
                        <h5>STK Push Sent!</h5>
                        <p>Check your phone (+254 ${mpesaNumber}) for M-Pesa prompt</p>
